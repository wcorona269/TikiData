...
user_seeds = [
    ['willy', 'wcorona269@gmail.com',
        'Passionate soccer enthusiast and goal scorer. Ready to conquer the field!'],
    ['spennybluntz', 'spencer@gmail.com',
        'Dribbling through life with a soccer ball. Let the games begin!'],
    ['GoalGetter', 'goalgetter@example.com',
        'Chasing dreams one goal at a time. Soccer is not just a game, it’s a way of life.'],
    ['SoccerFanatic', 'soccerfanatic@example.com',
        'Cheering for my favorite teams, living for the beautiful game. ⚽'],
    ['KickMaster', 'kickmaster@example.com',
        'Mastering the art of kicking and scoring goals. Soccer is my forte.'],
    ['GoalGalaxy', 'goalgalaxy@example.com',
        'Lost in the galaxy of goals. Join me in the soccer universe!'],
    ['DribbleKing', 'dribbleking@example.com',
        'Dribbling skills that mesmerize. On a mission to conquer the soccer kingdom.'],
    ['NetRipper', 'netripper@example.com', "Ripping the nets apart with powerful shots. Goalkeeper's nightmare!"],
    ['TikiTakaPro', 'tikitakapro@example.com',
        'Precision passing, tactical brilliance. Tiki-taka is my mantra.'],
    ['FutbolFever', 'futbolfever@example.com',
        'Feverishly passionate about futbol. Living and breathing the game.'],
    ['SoccerSniper', 'soccersniper@example.com',
        'Sniping goals from a distance. Precision and accuracy define my game.'],
    ['CornerFlagChamp', 'cornerflagchamp@example.com',
        'Claiming victory, one corner flag at a time. Soccer champ in the making.'],
    ['StadiumRoarer', 'stadiumroarer@example.com',
        'Roaring in the stadiums, supporting my team with all my heart.'],
    ['CrazyForGoals', 'crazyforgoals@example.com',
        'Crazy, passionate, and obsessed with goals. Scoring is my addiction.'],
    ['SoccerWizard', 'soccerwizard@example.com',
        'Magical moves and wizardry on the field. Turning soccer into an art form.'],
    ['GoalHoarder', 'goalhoarder@example.com',
        'Holding onto goals like treasures. Hoarding the glory, one goal at a time.'],
    ['DribbleMaestro', 'dribblemaestro@example.com', "Maestro of dribbling skills. Dancing through defenders like they're not there."],
    ['NetNinja', 'netninja@example.com',
        'Ninja-like reflexes guarding the net. Keeping the opponents at bay with precision saves.'],
    ['FreeKickMagician', 'freekickmagician@example.com',
        'Magical free kicks that bend the rules of physics. Watch and be amazed!'],
    ['SoccerSorcerer', 'soccersorcerer@example.com',
        'Sorcerer on the soccer field, casting spells with every touch.'],
    ['TheGoalHunter', 'thegoalhunter@example.com',
        'Hunting down goals, relentless in my pursuit of victory. Join me on the hunt!'],
    ['SoccerSupernova', 'soccersupernova@example.com',
        'A supernova of talent and passion, exploding onto the soccer scene.'],
    ['PitchProwler', 'pitchprowler@example.com',
        'Prowling the pitch, dominating every inch. Fear my presence on the field.'],
    ['SoccerSwagger', 'soccerswagger@example.com',
        'Swaggering through the soccer world with style and confidence.'],
    ['StadiumSultan', 'stadiumsultan@example.com',
        'Ruling the stadiums like a sultan. Commanding respect with every goal scored.'],
    ['GoalGladiator', 'goalgladiator@example.com',
